...
public class EnderecoController {
    ...
    @PostMapping
    public ResponseEntity<EnderecoResponseDTO> create(@RequestBody EnderecoCreateDTO dto){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EnderecoResponseDTO> update(@PathVariable Long id, @RequestBody EnderecoCreateDTO dto){
        Endereco endereco = EnderecoMapper.toEndereco(dto);
